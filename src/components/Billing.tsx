  ...
  <form className="space-y-6 md:space-y-9 md:w-[470px]">
    ...
    <div className="flex items-center gap-x-7">
      <div className="space-y-5">
        ...
        <input
          type="text"
          className="w-full border-2 border-gray-400 rounded-sm md:rounded-[10px] h-[40px] md:h-[75px] focus:outline-none focus:ring-0"
        />
      </div>
      <div className="space-y-5">
    ...
    <div className="space-y-5">
      ...
      <select
        className="w-full border-2 border-gray-400 rounded-sm md:rounded-[10px] h-[40px] md:h-[75px] focus:outline-none focus:ring-0 bg-white"
      >
        <option value="">
          Select Country
        </option>
