...
const Billing = () => {
  return (
    ...
    <div className='w-[400px] mx-auto lg:w-[508px] h-fit xl:w-[608px] py-9 lg:pb-14 lg:px-16 space-y-9'>
  <div>
    <h2 className='text-4xl font-semibold'>Billing Details</h2>
  </div>
  <form className="space-y-9 md:w-[470px]">
    ...
    <div className="flex items-center gap-x-7">
      <div className="space-y-5">
        ...
        <input
          type="text"
          className="w-full border-2 border-gray-400 rounded-[10px] h-[60px] md:h-[75px] focus:outline-none focus:ring-0"
        />
      </div>
      <div className="space-y-5">
    ...
    <div className="space-y-5">
      ...
      <select
        className="w-full border-2 border-gray-400 rounded-[10px] h-[60px] md:h-[75px] focus:outline-none focus:ring-0 bg-white"
      >
        <option value="">
          Select Country
        </option>
