    ...
    <div>
        <form className='space-y-11'>
            ...
            <div className='flex flex-col space-y-6'>
                ...
                <input type="email" className='border focus:ring-0 focus:outline-none border-black rounded-xl w-[300px] lg:w-[423px] h-[40px] lg:h-[75px]'/>
            </div>
            <div className='flex flex-col space-y-6'>
                <label htmlFor="Password" className='text-base font-medium'>Password</label>
                <input type="password" className='border focus:ring-0 focus:outline-none border-black rounded-xl w-[300px]  lg:w-[423px] h-[40px] lg:h-[75px]'/>
            </div>
            </div>
            <div className='space-y-9'>
            ...
            <button type='submit' className='border border-black rounded-xl text-xl py-4 px-10 lg:px-20'>Log In</button>
