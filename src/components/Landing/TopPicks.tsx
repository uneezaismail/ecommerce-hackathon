...
const SellingProducts = () => {
  ...
  return (
    <section className="w-full bg-[#e9e9e3] py-20 mx-auto px-2 lg:px-0 space-y-10 md:space-y-10 flex flex-col items-center justify-center relative">
   
      <div className="flex flex-col items-center gap-y-6 text-center">
        <h2 className="text-3xl md:text-4xl text-custom-green font-bold font-poppins">
          Top Picks For You
        </h2>
        <p className="font-medium text-gray-700 font-poppins">
