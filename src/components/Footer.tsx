...
const Footer = () => {
  return (
   <footer className='w-full bg-white text-custom-green font-medium px-4 lg:mx-0 h-fit py-6 md:py-8 lg:content-center'>
    ...
    <div className='flex flex-col gap-y-4 md:gap-y-6 lg:gap-y-12'>
                <span className='text-gray-500'>Newletter</span>
       <div className='flex items-center gap-x-2 sm:gap-x-3'>
        <input type="email" placeholder='Enter Your Email Address' className='focus:ring-0 focus:outline-none border-b border-b-black p-1 md:w-full w-[90%] bg-transparent'/>
